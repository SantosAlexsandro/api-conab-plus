...
import teamsWorkOrderNotificationService from "../../teams/services/TeamsWorkOrderNotificationService.js";
...
async function processCreateWorkOrder(job) {
  ...
  try {
    ...
    try {
      ...
      const teamsResult = await teamsWorkOrderNotificationService.sendWorkOrderCreatedNotification(notificationData);
    ...
    if (!oldestOrder) {
      ...
      if (result.technicianId) {
        ...
        try {
          ...
          const teamsResult = await teamsWorkOrderNotificationService.sendTechnicianAssignedNotification(
