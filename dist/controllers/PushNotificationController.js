"use strict";Object.defineProperty(exports, "__esModule", {value: true}); function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }var _PushNotificationService = require('../services/PushNotificationService'); var _PushNotificationService2 = _interopRequireDefault(_PushNotificationService);
...
class PushNotificationController {
  ...
  async subscribe(req, res) {
    try {
      ...
      await _PushNotificationService2.default.saveSubscription(subscription, userId);
  ...
  async unsubscribe(req, res) {
    try {
      ...
      try {
        await _PushNotificationService2.default.removeSubscription(endpoint);
    ...
    try {
      ...
      try {
        if (userId) {
          ...
          result = await _PushNotificationService2.default.sendToUser(userId, notificationData);
        } else if (endpoint) {
          console.log(`Enviando notificação para endpoint: ${endpoint.substr(0, 30)}...`);
          result = await _PushNotificationService2.default.sendToEndpoint(endpoint, notificationData);
        } else {
          console.log('Enviando notificação para todos os usuários');
          result = await _PushNotificationService2.default.sendToAll(notificationData);
        }
