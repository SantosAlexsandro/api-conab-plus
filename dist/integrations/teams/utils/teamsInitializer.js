"use strict";Object.defineProperty(exports, "__esModule", {value: true});var _teamsTokenRefreshQueuejs = require('../queues/teamsTokenRefreshQueue.js');
...
class TeamsInitializer {
  ...
  async setupPeriodicJobs() {
    try {
      ...
      await _teamsTokenRefreshQueuejs.schedulePeriodicRefresh.call(void 0, );
...
exports. default = teamsInitializer;
